...
<div class="container" style="width: 500px; margin-top: 50px;">
                <table class="table">
                    ...
                    <br>
                    <form action="<?php echo base_url(); ?>index.php/dashboard1/halaman_dua_waste_produksi" method="get">
                        <tr>
                            <!-- th><label for="tanggal">Tanggal</label></th>
                                <td><input type="date" id="tanggal" name="tanggal" class="form-control" value=""></td> -->
                            ...
                            <th><label for="nama_waste">Nama Waste</label></th>
                                <td>
                                    <select class="form-control" id="nama_waste" required name="nama_waste">
                                        ...
                                        <?php 
                                        foreach ($master_waste->result() as $row)
                                        {
                                            ?>
                        ...
                        <tr>
                            <th><label for="asal_waste">Asal Waste</label></th>
                                <td><input type="text" name="asal_waste" id="asal_waste" class="form-control" required autofocus maxlength="20" placeholder="Input Asal Waste"></td>
                        </tr>
                        <tr>
                            <th><label for="jumlah_karung">Jumlah Karung</label></th>
                                <td><input type="number" name="jumlah_karung" id="jumlah_karung" class="form-control" required autofocus maxlength="20" placeholder="Input Jumlah Karung"></td>
                        </tr>
                        <tr>
