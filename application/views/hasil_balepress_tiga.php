...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Input Hasil Balepress</li>
    </ol>
</section>
...
<div class="container" style="width: 600px; margin-top: 50px;">
                <table class="table">
                    ...
                    <br>
                    <form action="<?php echo base_url(); ?>index.php/Hasil_balepress/memasukan_data_halaman_dua_hasil_balepress" method="post">
                       <tr>
                            <th>No</th>
                            <th>No.Bale</th>
                            <th>Shift</th>
                        ...
                        for ($i=0; $i < $input_data; $i++) { 
                            ...
                            <tr>
                                <td><?php echo $no++ ?></td>
                                <td><input type="text" class="form-control" name="no_bale[]" required></td>
                        ...
                        <input type="hidden" name="tanggal" value="<?php echo $tanggal<?php
$this->load->view('template/head');
?>
...
<div class="container" style="width: 600px; margin-top: 50px;">
            <table class="table text-center">
                ...
                <form id="form-akhir" action="<?php echo base_url(); ?>index.php/Hasil_balepress/tiga_penyerahan_waste_produksi_ke_database?tanggal=<?php echo $tanggal?>" method="post"> 
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>No. Bale</th>
...
?> ?>">
                        <input type="hidden" name="nama_waste" value="">
                        <input type="hidden" name="asal_waste" value="">
                        <input type="hidden" name="jumlah_balepress" value="">
