...
<div class="container" style="width: 600px; margin-top: 50px;">
                <table class="table">
                    <h1 class="text-center">Hasil Balepress<?php echo $this->session->userdata('loger');?></h1>
                    <br>
                    <form action="<?php echo base_url(); ?>index.php/Hasil_balepress/tiga_input_hasil_balepress_ke_database?jumlah_bale=<?php echo $jumlah_bale ?>&tanggal=<?php echo $tanggal ?>" method="post">
                       <tr>
                            <th>No</th>
                            <th>No.Bale</th>
                            <th>Shift</th>
                        ...
                        <?php 
                        $no=1;
                        //$jumlah_bale karna isi dari jumlah tergantung dari banyaknya input bale di view 1
                        for ($i=0; $i < $jumlah_bale; $i++) { 
                            ?>
                            <tr>
                                <td><?php echo $no++ ?></td>
